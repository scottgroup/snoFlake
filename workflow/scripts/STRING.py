...
def main():
    ...
    interactions_df = pd.read_csv(interactions,delim_whitespace=True,usecols=['protein1','protein2'])
    ...
    remove_duplicate_edges(selected_interactions_df).to_csv(outfile, sep='\t',index=False)
