...
Launch with :
snakemake -j 999 --use-conda --immediate-submit --delete-temp-output --notemp --cluster-config cluster.json --cluster 'python3 workflow/scripts/slurmSubmit.py {dependencies}'
"""
